...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-k8s/flexsearch.min.js');loadScript('/study-k8s/en.search-data.min.9a1c63c02e22a68b2d8f9be2d62c171a922805c962c642ed2fa3c7a2dafcbd04.js',function(){input.required=false;search();});}
