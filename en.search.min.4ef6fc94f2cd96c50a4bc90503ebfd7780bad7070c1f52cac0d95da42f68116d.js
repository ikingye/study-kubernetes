...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-k8s/flexsearch.min.js');loadScript('/study-k8s/en.search-data.min.aaeb45c03880df5f233d1523b703634f26c891759c03c20a41a0c94deec8c662.js',function(){input.required=false;search();});}
