...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-kubernetes/flexsearch.min.js');loadScript('/study-kubernetes/en.search-data.min.24915e6cbf739860dda7fef1765ac77aa563dda247934ca6704b41bf6e918d1f.js',function(){input.required=false;search();});}
