...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-kubernetes/flexsearch.min.js');loadScript('/study-kubernetes/en.search-data.min.9e47de88ce8396a2bf2aa51635bee1c054cf2e37eca5db4a2d0a230645638869.js',function(){input.required=false;search();});}
