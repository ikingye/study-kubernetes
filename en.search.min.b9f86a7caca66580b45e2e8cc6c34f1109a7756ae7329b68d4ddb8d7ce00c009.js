...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-k8s/flexsearch.min.js');loadScript('/study-k8s/en.search-data.min.3d3b207cd23183fd6682f4c9d7ec9e85bd459250531c4d72fdb17a856caf1dd7.js',function(){input.required=false;search();});}
