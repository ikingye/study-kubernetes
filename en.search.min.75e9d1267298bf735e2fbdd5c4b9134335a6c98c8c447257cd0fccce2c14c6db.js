...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-kubernetes/flexsearch.min.js');loadScript('/study-kubernetes/en.search-data.min.4b48cfdfa6fbe3f1c795954722cd57d2975fe75f8e08d11b25d5acd849e7c7ae.js',function(){input.required=false;search();});}
