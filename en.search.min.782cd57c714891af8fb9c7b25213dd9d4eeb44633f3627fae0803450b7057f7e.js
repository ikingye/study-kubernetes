...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-kubernetes/flexsearch.min.js');loadScript('/study-kubernetes/en.search-data.min.814aab82fb0b8ecb30a18408ac0d995446ad0db5774c60aa15e82a93390e68b5.js',function(){input.required=false;search();});}
