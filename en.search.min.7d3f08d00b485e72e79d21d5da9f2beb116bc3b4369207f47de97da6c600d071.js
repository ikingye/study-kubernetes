...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-kubernetes/flexsearch.min.js');loadScript('/study-kubernetes/en.search-data.min.2e10c67dcb79ccafbde1d30e2052ba4ea322763af411c05a3abf1d710403041a.js',function(){input.required=false;search();});}
