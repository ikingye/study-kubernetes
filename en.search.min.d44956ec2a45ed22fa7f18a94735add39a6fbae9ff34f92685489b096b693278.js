...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-kubernetes/flexsearch.min.js');loadScript('/study-kubernetes/en.search-data.min.0060f4448bae6ace8f558d6f5649f9d5efd2dc506d8a52af57aa38cda97a7908.js',function(){input.required=false;search();});}
