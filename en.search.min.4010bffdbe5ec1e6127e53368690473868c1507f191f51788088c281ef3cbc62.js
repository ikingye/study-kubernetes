...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-kubernetes/flexsearch.min.js');loadScript('/study-kubernetes/en.search-data.min.a42747241e7d76c854d7959ede388c86ff0ffa25a8bc35335e1e2a8cfdb96f65.js',function(){input.required=false;search();});}
