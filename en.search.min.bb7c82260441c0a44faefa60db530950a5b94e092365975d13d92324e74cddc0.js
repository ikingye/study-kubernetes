...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-kubernetes/flexsearch.min.js');loadScript('/study-kubernetes/en.search-data.min.51dd450e7490cb275b0cf88ec1a6d9879201cd6ef7cac21a9d9986dda889aa6a.js',function(){input.required=false;search();});}
