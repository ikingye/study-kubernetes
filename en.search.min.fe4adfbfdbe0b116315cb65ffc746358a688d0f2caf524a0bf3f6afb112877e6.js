...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-k8s/flexsearch.min.js');loadScript('/study-k8s/en.search-data.min.56142e93e7a32747060a484f1587b6667a6a01bf6cfccc6849ff5dc0baaefa6d.js',function(){input.required=false;search();});}
