...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-k8s/flexsearch.min.js');loadScript('/study-k8s/en.search-data.min.ed612f5c799119ff7c22e5e7fb6f96627527f217901473e008fcb0d2b464d4a7.js',function(){input.required=false;search();});}
