...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-kubernetes/flexsearch.min.js');loadScript('/study-kubernetes/en.search-data.min.9ed8371f5e6f96f313fb7fbdef9596a99b79600966dd4413955d651374afe07c.js',function(){input.required=false;search();});}
