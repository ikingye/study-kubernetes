...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-k8s/flexsearch.min.js');loadScript('/study-k8s/en.search-data.min.79b2c7a1afbc360b2dbd3914d4acec13934d7f81cabb8f96a848317b709b4081.js',function(){input.required=false;search();});}
