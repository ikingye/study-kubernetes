...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-k8s/flexsearch.min.js');loadScript('/study-k8s/en.search-data.min.4781c443bb8227d210512a6621cb84c432fe6bfe09920915a6301d104cddeb57.js',function(){input.required=false;search();});}
