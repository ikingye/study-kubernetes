...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-kubernetes/flexsearch.min.js');loadScript('/study-kubernetes/en.search-data.min.987ef6f9e0d33bb4f18becc19c352683391ec9a9a59319bde343a74c6670fe6c.js',function(){input.required=false;search();});}
