...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-k8s/flexsearch.min.js');loadScript('/study-k8s/en.search-data.min.1506dd73b52965c232364608997d6b3e090d803dd717e600b6dd53a7d963f8d8.js',function(){input.required=false;search();});}
