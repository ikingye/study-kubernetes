...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-k8s/flexsearch.min.js');loadScript('/study-k8s/en.search-data.min.ab44273f0416b5d066465258c4d23bbb07b3d69384783d4eb6ce42d3280b1176.js',function(){input.required=false;search();});}
