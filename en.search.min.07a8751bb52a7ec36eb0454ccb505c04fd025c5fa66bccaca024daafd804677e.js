...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-k8s/flexsearch.min.js');loadScript('/study-k8s/en.search-data.min.c70692cea2dbcaa380eb5ff54cff0ea08d4f4804a5c095ce79ff98ec22474275.js',function(){input.required=false;search();});}
