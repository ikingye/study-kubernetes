...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-k8s/flexsearch.min.js');loadScript('/study-k8s/en.search-data.min.d760c3fe546897a0dc71bdfaf9e5da398463b676deaa56047f77c2bf46770218.js',function(){input.required=false;search();});}
