...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-kubernetes/flexsearch.min.js');loadScript('/study-kubernetes/en.search-data.min.a47c5f76f72c48675252fd3359eb5734f309fd2154a58d5fbbcf310a4e2e20c5.js',function(){input.required=false;search();});}
