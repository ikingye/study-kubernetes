...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-kubernetes/flexsearch.min.js');loadScript('/study-kubernetes/en.search-data.min.be434de260f082eacc809acaa9c9243acdc8ef42884e53af0fdd2bc7ab2b956e.js',function(){input.required=false;search();});}
