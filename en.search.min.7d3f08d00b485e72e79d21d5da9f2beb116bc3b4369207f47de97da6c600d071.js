...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-k8s/flexsearch.min.js');loadScript('/study-k8s/en.search-data.min.2e10c67dcb79ccafbde1d30e2052ba4ea322763af411c05a3abf1d710403041a.js',function(){input.required=false;search();});}
