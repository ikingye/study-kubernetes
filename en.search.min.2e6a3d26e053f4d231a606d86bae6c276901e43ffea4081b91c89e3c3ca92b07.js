...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-k8s/flexsearch.min.js');loadScript('/study-k8s/en.search-data.min.064002be8a3d4973709ebf56c164d2ffba128b47aab839e03dbaacb2987bc6f6.js',function(){input.required=false;search();});}
