...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-k8s/flexsearch.min.js');loadScript('/study-k8s/en.search-data.min.6a036d15efe00b83ff183941390013cd8901f74414f5e915a006723e03f08539.js',function(){input.required=false;search();});}
