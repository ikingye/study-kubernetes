...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-k8s/flexsearch.min.js');loadScript('/study-k8s/en.search-data.min.2750a3c244ae8240d9512f0bb975ffe5ab2ab4aa88e4897b63fe373018e30880.js',function(){input.required=false;search();});}
