...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-k8s/flexsearch.min.js');loadScript('/study-k8s/en.search-data.min.ea4cea0f08dca161583f439febfa41f383012de856facd7b02d27b9661921b57.js',function(){input.required=false;search();});}
