...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-k8s/flexsearch.min.js');loadScript('/study-k8s/en.search-data.min.34c00effa7342117bfafa3badebc2e823a1d9c29dd0b18f5c21d9be84bc0cf8f.js',function(){input.required=false;search();});}
