...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-k8s/flexsearch.min.js');loadScript('/study-k8s/en.search-data.min.a3a17e272e3de6ef5a0b06133e66ee69f563ccecc3ba906c124e294177512c60.js',function(){input.required=false;search();});}
