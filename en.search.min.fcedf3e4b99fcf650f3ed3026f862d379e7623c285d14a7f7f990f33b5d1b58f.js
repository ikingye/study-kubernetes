...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-kubernetes/flexsearch.min.js');loadScript('/study-kubernetes/en.search-data.min.fdc09aab6a6382afa537b40ff8eee1a0d384d98e0484cd4b70f49e15ab4bafe9.js',function(){input.required=false;search();});}
