...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-k8s/flexsearch.min.js');loadScript('/study-k8s/en.search-data.min.06bf411f7b295f89ccc82e6ca1c60f5a5236cfad436985cdb5dc12439ac21e8a.js',function(){input.required=false;search();});}
