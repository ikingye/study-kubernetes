...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-kubernetes/flexsearch.min.js');loadScript('/study-kubernetes/en.search-data.min.22a9ec4c2f76c0adae2ccdddaf5bd71b0b20460573a997604e442038566af7e0.js',function(){input.required=false;search();});}
