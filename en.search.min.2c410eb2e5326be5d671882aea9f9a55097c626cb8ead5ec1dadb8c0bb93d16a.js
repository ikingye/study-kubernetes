...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-k8s/flexsearch.min.js');loadScript('/study-k8s/en.search-data.min.a122957204665580b1310f363c9d175c9d26e5bcea59ffdb854030537085278c.js',function(){input.required=false;search();});}
