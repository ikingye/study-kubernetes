...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-k8s/flexsearch.min.js');loadScript('/study-k8s/en.search-data.min.f203bd3356334c3c98af5bbff0178d593ce46a1e5a095a2b2f61ae396326d822.js',function(){input.required=false;search();});}
