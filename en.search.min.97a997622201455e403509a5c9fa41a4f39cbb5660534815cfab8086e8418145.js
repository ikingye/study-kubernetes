...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-kubernetes/flexsearch.min.js');loadScript('/study-kubernetes/en.search-data.min.6da790e033bdb8d58aff1bccffef3c808084c045d56b7fd47a82f56782e2e2e3.js',function(){input.required=false;search();});}
