...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-k8s/flexsearch.min.js');loadScript('/study-k8s/en.search-data.min.252ac28783ef4b887315d108d988863783adb0745275a7808795a823d9e73bc0.js',function(){input.required=false;search();});}
