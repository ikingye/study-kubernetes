...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-k8s/flexsearch.min.js');loadScript('/study-k8s/en.search-data.min.1d2f6626f7a7b96e9197da8b1fc5147a471bcb105d8b247ef0319a6d1a12d060.js',function(){input.required=false;search();});}
