...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-k8s/flexsearch.min.js');loadScript('/study-k8s/en.search-data.min.7ace08a8c4bcc2779fdde170b4b50ed49a0779ffb7da6cf87730b309232272f5.js',function(){input.required=false;search();});}
