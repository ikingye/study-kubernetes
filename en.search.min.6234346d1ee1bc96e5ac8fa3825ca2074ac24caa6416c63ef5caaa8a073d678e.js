...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-k8s/flexsearch.min.js');loadScript('/study-k8s/en.search-data.min.cb0322cd228329c3a5c0de400a7af30610aa2256049da03f439ffd0d5e70329c.js',function(){input.required=false;search();});}
