...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-kubernetes/flexsearch.min.js');loadScript('/study-kubernetes/en.search-data.min.4572d748085ac998a2ee9cf6e0500360ecc6e4b17cdcf249d3fe73ece54decfc.js',function(){input.required=false;search();});}
